...
Commit `64a893a`. Commande : `node docs/preuves/1.2.0/mutations.mjs`.

| Mutation | Tests lances, et leur resume | Verdict |
| -------- | ---------------------------- | ------- |
| M1 · le plancher relit sa propre propriete, forme de la 1.1.0 | gardes/gardes.test.ts, tests/cycles.test.ts, tests/densites.test.ts, tests/non-regression.test.ts · Tests  15 failed | 104 passed (119) | rougit |
...
| M4 · un lien sortant perd noreferrer | tests/composants/bouton-lien.test.tsx, tests/composants/ligne-lien.test.tsx · Tests  4 failed | 44 passed (48) | rougit |
...
| M8 · la copie avale son echec | tests/composants/valeur-copiable.test.tsx · Tests  2 failed | 10 passed (12) | rougit |
| M9 · la ligne perd sa hauteur de densite | tests/composants/ligne-lien.test.tsx · Tests  1 failed | 12 passed (13) | rougit |
| M10 · un survol de bouton sort de la garde (hover: hover) | tests/composants/bouton-lien.test.tsx · Tests  1 failed | 34 passed (35) | rougit |
...
| M13 · la garde distribuee exige de nouveau la forme fautive | gardes/gardes.test.ts · Tests  5 failed | 35 passed (40) | rougit |
